...
/** Release-channel pill next to the wordmark, matching the sidebar header. */
...
/**
 * The page the loopback flow lands on after Clerk redirects back to the CLI's
 * local port. Styled like the web app's connect pages, which in turn mirror
 * the app's dialogs; this one is static HTML because the server serves it
 * with no web bundle in reach.
 */
